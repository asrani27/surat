...
<table cellpadding="2" class="auto-style3" style="width: 100%">
	<tr>
		...
		<hr /><strong>LAPORAN SURAT MASUK<br />
		...
		<table cellpadding="3" cellspacing="0" class="auto-style8" style="width: 100%">
			<tr>
				...
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Pengirim</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Sifat Surat</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Jenis Surat</strong></td>
                ...
                <tr>
                    ...
                    <td class="auto-style10">{{$item->pengirim}}</td>
                    <td class="auto-style10">{{$item->sifat}}</td>
                    <td class="auto-style10">{{$item->jenis}}</td>

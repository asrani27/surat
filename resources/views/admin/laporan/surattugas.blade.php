...
<table cellpadding="2" class="auto-style3" style="width: 100%">
	<tr>
		...
		<hr /><strong>LAPORAN SURAT TUGAS<br />
		...
		<table cellpadding="3" cellspacing="0" class="auto-style8" style="width: 100%">
			<tr>
				...
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Pemberi Tugas</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Penerima Tugas</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Perihal</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Isi Surat</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Tempat</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Nama Instansi</strong></td>
			</tr>
                @php
                    $no =1;
                @endphp
                ...
                <tr>
                    ...
                    <td class="auto-style10">{{$item->pemberitugas->nama}}</td>
                    <td class="auto-style10">{{$item->penerimatugas->nama}}</td>
                    <td class="auto-style10">{{$item->perihal}}</td>
                    <td class="auto-style10">{{$item->isi_surat}}</td>
                    <td class="auto-style10">{{$item->tempat}}</td>
                    <td class="auto-style10">{{$item->nama_instansi}}</td>
                </tr>
                @endforeach
		</table>
		<br />

...
<table cellpadding="2" class="auto-style3" style="width: 100%">
	<tr>
		...
		<hr /><strong>LAPORAN SURAT PINJAM<br />
		...
		<table cellpadding="3" cellspacing="0" class="auto-style8" style="width: 100%">
			<tr>
				...
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Alamat Tujuan</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Jumlah</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Keterangan</strong></td>
				<td class="auto-style10" style="height: 24px;text-align: center"><strong>Tanggal Kegiatan</strong></td>
                ...
                <tr>
                    ...
                    <td class="auto-style10">{{$item->jumlah}}</td>
                    <td class="auto-style10">{{$item->keterangan}}</td>
